...
import com.kostynchikoff.core_application.data.constants.CorePatternConstant.PATTERN_DEFOULT_PHONE_NUMBER


class PhoneNumberTextWatcher(
    private val mEditText: EditText?,
    private val mask: String? = PATTERN_DEFOULT_PHONE_NUMBER,
    ...
    override fun onTextChanged(
        ...
        if (!isUpdating && countryCode == "") {
            val text = str.replace(" ", "").replace("+", "")
            val m: String? = mask
